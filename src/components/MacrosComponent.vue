<template>
	<div class="px-[32px] pb-0 absolute bottom-0 w-full">
		<div class="container max-w-[600px] p-[16px] pb-0">
			<div class="macros bg-[#d9d9d9] rounded-t-md p-[16px] pb-0">
				<div class="total">
					<progress
						class="w-full progress-unfilled:bg-[#F2F2F2]"
						:class="{
							'progress-filled:bg-blue-600': storeEatenProducts.TotalCalories < totalCalories,
							'progress-filled:bg-red-600': storeEatenProducts.TotalCalories > totalCalories,
						}"
					...
					<span
						...
						><span class="font-semibold">KCAL:</span> {{ storeEatenProducts.TotalCalories }}/{{ totalCalories }}</span
					>
				</div>
				<div class="macro-elements flex justify-between text-[14px]">
					...
					<div class="element w-[30%]">
						<progress
							class="w-full progress-unfilled:bg-[#F2F2F2]"
							:class="{
								'progress-filled:bg-blue-700': storeEatenProducts.TotalCarbs < carbsCalories,
								'progress-filled:bg-red-600': storeEatenProducts.TotalCarbs > carbsCalories,
							}"
						...
						>
							...
							<span>{{ storeEatenProducts.TotalCarbs }}/{{ carbsCalories }}g</span>
						</div>
					</div>
					...
					<div class="element w-[30%]">
						<progress
							class="w-full progress-unfilled:bg-[#F2F2F2]"
							:class="{
								'progress-filled:bg-blue-800': storeEatenProducts.TotalProteins < proteinslCalories,
								'progress-filled:bg-red-600': storeEatenProducts.TotalProteins > proteinslCalories,
							}"
							:value="storeEatenProducts.TotalProteins"
							:max="proteinslCalories"
						></progress>

						<div
							class="flex flex-col items-center justify-center"
							:class="{
								'text-red-600': storeEatenProducts.TotalProteins > proteinslCalories,
							}"
						>
							<span class="font-semibold">P:</span>
							<span>{{ storeEatenProducts.TotalProteins }}/{{ proteinslCalories }}g</span>
						</div>
					</div>
					...
					<div class="element w-[30%]">
						<progress
							class="w-full progress-unfilled:bg-[#F2F2F2]"
							:class="{
								'progress-filled:bg-blue-900': storeEatenProducts.TotalFats < fatsCalories,
								'progress-filled:bg-red-600': storeEatenProducts.TotalFats > fatsCalories,
							}"
